...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CONTRIBUTORS".freeze, "GPL".freeze, "HACKING".freeze, "LEGAL".freeze, "LICENSE".freeze, "LICENSE.rubyspec".freeze, "NEWS".freeze, "README".freeze]
  s.files = ["CONTRIBUTORS".freeze, "GPL".freeze, "HACKING".freeze, "LEGAL".freeze, "LICENSE".freeze, "LICENSE.rubyspec".freeze, "MANIFEST".freeze, "NEWS".freeze, "README".freeze, "lib/io/like.rb".freeze]
